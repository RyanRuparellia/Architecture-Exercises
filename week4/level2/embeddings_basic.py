...
sentences = [
    #These sentences are about fruit. The goal is to see which are most similar in meaning.
    "I like apples and oranges",
    "Citrus fruits are tasty", # semantically similar to first, cosine should be high
    "My grandma's apple pie relies on butter, cinnamon, and patience.", # lexically similar to first, cosine should be lower
    "Desserts are essential for my mental health", #surprisingly high cosine to first two

    "The Eiffel Tower is located in Paris.",
    "The Great Wall of China is a historic landmark.",
    "Mount Everest is the highest mountain in the world.",
    "The Amazon rainforest is home to diverse wildlife.",
    #not a high similarity between these four sentences. Expected higher cosine within this group.
